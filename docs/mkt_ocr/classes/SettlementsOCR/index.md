...
- **Gestión de Fallos:** Si el servicio de OCR no logra extraer la información correctamente, el sistema registra automáticamente el incidente en el modelo `ocr.usage.log` para su posterior análisis.
